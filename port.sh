...
arr4=$(echo $t4 |cat - a4.txt | sed 's/,//g')
...
echo -e "$tmp1\t$tmp2\t$tmp7\t$tmp5\t$tmp6\t$tmp3\t$tmp4"

line=`expr $line + 1`
done

rm a1.txt a2.txt a3.txt a4.txt a5.txt a6.txt a7.txt
rm extensive.txt physical.txt
